...
settings = dict(
    ...
    machine_organization_name   = environ.get('MACHINE_ORGANIZATION_NAME', 'machina-ratiocinatrix'),
    private_repo_with_text      = environ.get('PRIVATE_REPO_WITH_TEXT','switching_machine'),
